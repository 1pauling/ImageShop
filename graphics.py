...
class Text(GraphicsObject):
    ...
    def setFace(self, face):
        if face in ['helvetica','arial','courier','times roman','Phosphate Inline',
                    'Lucida Handwriting']:
...
class ImageGUI(GraphicsObject):
    ...
    def __init__(self, p, *pixmap):
        GraphicsObject.__init__(self, [])
        self.anchor = p.clone()
        self.imageId = ImageGUI.idCount
        ImageGUI.idCount = ImageGUI.idCount + 1
